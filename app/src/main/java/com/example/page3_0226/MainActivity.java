...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        page3_recyclerview = (RecyclerView)findViewById(R.id.page3_recyclerview);
        ...
        //구분선 넣기
        page3_recyclerview.addItemDecoration(new DividerItemDecoration(MainActivity.this, DividerItemDecoration.VERTICAL));
    }
}
